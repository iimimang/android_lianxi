...
public class TemplateAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		// viewHolder.templename = (TextView)
		// convertView.findViewById(R.id.templename);
		// viewHolder.templeid = (TextView)
		// convertView.findViewById(R.id.templeid);
		...
		LayoutInflater _LayoutInflater = LayoutInflater.from(mContext);
		convertView = _LayoutInflater.inflate(R.layout.template_spinner_items,
				null);
		if (convertView != null) {
			TextView templename = (TextView) convertView
					.findViewById(R.id.templename);
