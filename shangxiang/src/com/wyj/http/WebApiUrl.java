...
public class WebApiUrl  {
	...
	public static final String GET_USERINFO = IP + PORT + "/api/app/getmemberinfo.php";  //读取用户信息接口
	public static final String MEMBERINFO = IP + PORT + "/api/app/modifymemberinfodo.php"; //用户资料修改接口
