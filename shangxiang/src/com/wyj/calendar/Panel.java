...
public class Panel extends LinearLayout {
	...
	protected void onFinishInflate() {
		...
		mHandle = findViewById(R.id.foli_bottom_image);
		if (mHandle == null) {
            throw new RuntimeException("Your Panel must have a View whose id attribute is 'R.id.foli_bottom_image'");
		}
		mHandle.setOnTouchListener(touchListener);
		
		mContent = findViewById(R.id.popupwindow_calendar);
		if (mContent == null) {
            throw new RuntimeException("Your Panel must have a View whose id attribute is 'R.id.popupwindow_calendar'");
		}
