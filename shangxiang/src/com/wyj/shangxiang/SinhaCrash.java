...
public class SinhaCrash implements UncaughtExceptionHandler {
	public static final String TAG = "SinhaCrash";
	private Thread.UncaughtExceptionHandler handler;
	private static SinhaCrash INSTANCE = new SinhaCrash();
	...
	public static SinhaCrash getInstance() {
		return INSTANCE;
	}
