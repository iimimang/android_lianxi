...
public class UploadPostUtil {
    ...
    public static String uploadFile(String uploadUrl,String srcPath,String username)
    {
      String end = "\r\n";
      String twoHyphens = "--";
      String boundary = "******";
    ...
    public static String post(String actionUrl, Map<String, String> params, 
          ...
          if(files!=null){
            ...
            for (Map.Entry<String, File> file: files.entrySet()) { 
              ...
              sb1.append("Content-Disposition: form-data; name=\"uploadedfile\"; filename=\""+file.getKey()+"\""+LINEND);
