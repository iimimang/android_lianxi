...
import com.panduola.android.Consts;
import com.panduola.android.PanDuoLa;
import com.panduola.android.R;
import com.panduola.android.activity.Navigation;
...
public class UpdateService extends Service {
	...
	public int onStartCommand(Intent intent, int flags, int startId) {
		try {
			...
			this.notification.tickerText = PanDuoLa.APP.getString(R.string.update_ticker_title);
			this.notification.setLatestEventInfo(this, PanDuoLa.APP.getString(R.string.app_name), PanDuoLa.APP.getString(R.string.update_notification_ready), this.pi);
	...
	private Handler updateHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case DOWNLOAD_COMPLETE:
				...
				UpdateService.this.notification.setLatestEventInfo(UpdateService.this, PanDuoLa.APP.getString(R.string.app_name), PanDuoLa.APP.getString(R.string.update_notification_download_success), UpdateService.this.pi);
				UpdateService.this.nm.notify(0, UpdateService.this.notification);
				stopService(UpdateService.this.intent);
				break;
			case DOWNLOAD_FAIL:
				UpdateService.this.notification.setLatestEventInfo(UpdateService.this, PanDuoLa.APP.getString(R.string.app_name), PanDuoLa.APP.getString(R.string.update_notification_download_error), UpdateService.this.pi);
				UpdateService.this.nm.notify(0, UpdateService.this.notification);
				break;
			default:
				stopService(UpdateService.this.intent);
		...
		try {
			...
			while ((readsize = is.read(buffer)) > 0) {
				...
				if (intDisplaySize == 0 || (int) (lngCurrentSize * 100 / intTotalSize) - 1 > intDisplaySize) {
					intDisplaySize += 1;
					this.notification.setLatestEventInfo(UpdateService.this, PanDuoLa.APP.getString(R.string.app_name), PanDuoLa.APP.getString(R.string.update_notification_downloading) + " " + (int) (lngCurrentSize * 100 / intTotalSize) + "%", pi);
