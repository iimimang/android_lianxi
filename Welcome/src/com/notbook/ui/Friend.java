...
public class Friend extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		addfriend.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(Friend.this, FriendAdd.class);
				intent.putExtra("name", "FriendAdd1");
		...
		friendtext.addTextChangedListener(new TextWatcher() {
			...
			public void afterTextChanged(Editable s) {
				...
				if (input_str != null && !"".equals(input_str)
					...
					ContactListAdapter yuer = new ContactListAdapter(input_check_list,Friend.this);
					mListView.setAdapter(yuer);
					yuer.notifyDataSetChanged();
				} else {
					ContactListAdapter yuer = new ContactListAdapter(lists,Friend.this);
					mListView.setAdapter(yuer);
					yuer.notifyDataSetChanged();
				}
			}
		...
		sender.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				if (Eventlist.mtime.equals("正点提醒")) {
					mtime = "0";
				}
				if (Eventlist.mtime.equals("提前5分钟")) {
					mtime = "5";
				}
				if (Eventlist.mtime.equals("提前10分钟")) {
					mtime = "10";
				}
				if (Eventlist.mtime.equals("提前一小时")) {
					mtime = "60";
				}
				if (Eventlist.mtime.equals("提前一天")) {
					mtime = "1440";
				...
				if (flag == false) {
					Toast.makeText(Friend.this, "请选择好友", 0).show();
					return;
				}
				...
				url = com.notbook.app.Info.uri
						...
						+ Uri.encode(Eventlist.time) + "&advtime="
						+ Uri.encode(mtime) + "&recuser=" + Uri.encode(phone)
						+ "&text=" + Uri.encode(Eventlist.jishi) + "&tone="
						+ Uri.encode(Eventlist.lingyin) + "&first="
						+ Uri.encode(Eventlist.youxian) + "&recname="
						+ Uri.encode(name) + "&ctype="
						+ Uri.encode(Eventlist.leixing) + "&cname="
						+ Uri.encode(Eventlist.zhuti);
				if (Eventlist.imageurl.equals("") || Eventlist.imageurl == null) {
	...
	public void init() {
		...
		iamgebutton1.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(Friend.this, MainActivity0.class);
				startActivity(intent);
			}
		});
		...
		iamgebutton2.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(Friend.this, MainActivity2.class);
				startActivity(intent);
			}
		});
		...
		iamgebutton3.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(Friend.this, MainActivity3.class);
				startActivity(intent);
			}
		});
		...
		iamgebutton4.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(Friend.this, MainActivity4.class);
				startActivity(intent);
			}
		});
		...
		iamgebutton5.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(Friend.this, MainActivity1.class);
				startActivity(intent);
			}
		});
	}
	...
	class TextAsyncTask extends AsyncTask<String, Integer, String> {
		...
		protected void onPreExecute() {
			dia = new ProgressDialog(Friend.this);
			dia.setMessage("正在发送...");
			dia.show();
		...
		protected void onPostExecute(String result) {
			if (result == null) {
				Toast.makeText(Friend.this, "网络加载失败..", 0).show();
				dia.dismiss();
			} else {
				...
				try {
					...
					if (share1 == 10) {
						Intent intent = new Intent(Friend.this,
								Hudianlist.class);
						startActivity(intent);
						Toast.makeText(Friend.this, "发送成功", 0).show();
					}
	...
	class HttpMultipartPost extends AsyncTask<HttpResponse, Integer, String> {
		...
		protected String doInBackground(HttpResponse... arg0) {
			...
			try {
				...
				File file = new File(Eventlist.imageurl);
				File file1 = new File(Eventlist.luyin);
				...
				dia.dismiss();
				Intent intent = new Intent(Friend.this, Hudianlist.class);
				startActivity(intent);
				Toast.makeText(Friend.this, "发送成功", 0).show();
