...
import com.notbook.ui.Frienddetail.TextAsyncTask;
...
public class ContactListAdapter1 extends BaseAdapter {
	...
	private String url = "";
	public ContactListAdapter1(List<ContactBean> peoples, Context context) {
...
//		beanname = bean.getContactPhone().replaceAll(" ", "");
			...
			if(peoples.get(position).getContactid().equals("1")){
				...
				holder.contact.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						...
						url = Info.uri+"/addFellowAction.php?uphone="+Login.uphone+"&fphone="+beanname;
...
//						holder.image.setVisibility(View.INVISIBLE);
			...
			if(peoples.get(position).getContactid().equals("0")){
			...
			if(peoples.get(position).getContactid().equals("2")){
				holder.tv_number.setText("已添加");
	...
	class TextAsyncTask1 extends AsyncTask<String, Integer, String> {
		...
		public TextAsyncTask1(ViewHolder holder) {
			this.holder = holder;
			// TODO Auto-generated constructor stub
		}
		@Override
