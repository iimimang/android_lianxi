...
public class Birthday_detail extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.back_login:
			...
			bak_login.setClass(Birthday_detail.this, Login.class);
	...
	private void checkapi(String reg_username, String reg_passwd) {
			...
			public void handleMessage(Message msg) {
				if (msg.what == 0x123) {
					...
					if (resmsg.get("code").equals("succeed")) {
						RegularUtil.alert_msg(Birthday_detail.this, "注册成功");
						finish();
					} else {

						RegularUtil.alert_msg(Birthday_detail.this,"注册失败，" + resmsg.get("msg"));
					}
		...
		pDialog = new ProgressDialog(Birthday_detail.this);
